...
/**
 * struct passinfo - contain pseudo-arguements
 * @arg: stringg generated from getline containing arguments
 * @argv:an arrayy off stringss generatedd from arg
 * @path: string path for current commandd
 * @argc: argumentt count
 * @line_count: error count
 * @err_num: error code for exit
 * @linecount_flag: if on count this line of input
 * @fname: file name
 * @env: linked list in environment
 * @environ: environt
